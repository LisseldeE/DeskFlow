...
TRANSLATIONS = {
    "zh_CN": {
        ...
        "hotkey_capsule": "主胶囊栏",
        "hotkey_clear": "清除",
        "hotkey_clear_tip": "清除该功能的快捷键",
        "hotkey_reset": "重置",
        "hotkey_reset_tip": "将所有快捷键恢复为默认设置",
        "hotkey_hint": "点击输入框后按下快捷键组合（需包含 Ctrl、Alt、Shift 或 Win），修改后立即生效并自动保存；按 Backspace 或点击“清除”可清空。",
        "hotkey_conflict": "快捷键 {seq} 已被其他功能或系统占用，已还原。",
        "hotkey_invalid": "快捷键需至少包含一个修饰键（Ctrl / Alt / Shift / Win）。",
        "tool_order": "图标顺序",
        "tool_order_hint": "拖拽调整工具在胶囊中的排列顺序；点击眼睛图标可显示或隐藏该功能按钮。修改后立即生效并保存。",
        "tool_hide": "在胶囊栏中隐藏",
        "tool_show": "在胶囊栏中显示",
        "settings_title": "设置",
        "autostart": "开机自启",
    ...
    "en": {
        ...
        "hotkey": "Hotkey",
        # Hotkey settings
        "hotkey_capsule": "Capsule",
        "hotkey_clear": "Clear",
        "hotkey_clear_tip": "Clear the hotkey for this feature",
        "hotkey_reset": "Reset",
        "hotkey_reset_tip": "Restore all hotkeys to default settings",
        "hotkey_hint": "Click the field and press a key combination (must include Ctrl, Alt, Shift or Win). Changes take effect and save immediately; press Backspace or click \"Clear\" to reset.",
        "hotkey_conflict": "The hotkey {seq} is already in use by another feature or the system. Change reverted.",
        "hotkey_invalid": "The hotkey must include at least one modifier key (Ctrl / Alt / Shift / Win).",
        "tool_order": "Tool Order",
        "tool_order_hint": "Drag to reorder the tools in the capsule. Click the eye icon to show or hide a tool's button. Takes effect and saves immediately.",
        "tool_hide": "Hide from capsule",
        "tool_show": "Show in capsule",
